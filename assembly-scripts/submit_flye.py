...
technologies = [{"name": "ont", "arg": "--nano-raw"},
                {"name": "pacbio", "arg": "--pacbio-raw"},
...
for genome in genomes:
    ...
    for technology in technologies:
        ...
        for length in lengths:
            ...
            sbatch_parameters = open("sbatch_parameters/flye_" + genome["length"] + ".txt", "r")
            script.write(sbatch_parameters.read())

            srun_line = "srun flye " + technology["arg"] + " " + read_file \
                + " --threads " + str(genome["threads"]) \
                + " --out-dir " + output_dir
